...
(defsystem "dji_sdk-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "LandingActivation" :depends-on ("_package_LandingActivation"))
    (:file "_package_LandingActivation" :depends-on ("_package"))
    (:file "LandingData" :depends-on ("_package_LandingData"))
    (:file "_package_LandingData" :depends-on ("_package"))
